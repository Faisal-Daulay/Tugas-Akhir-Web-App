                ...
                <table class="table datatable">
                    ...
                    <tbody>
                        <?php
                            ...
                            $dml = "SELECT * FROM jadwal INNER JOIN pengajar ON jadwal.id_guru = pengajar.id_guru INNER JOIN kelas ON jadwal.id_kelas = kelas.id_kelas INNER JOIN kursus ON jadwal.id_kursus = kursus.id_kursus WHERE jadwal.id_guru = '$id_guru' ";
                            $result = $db -> query($dml);
