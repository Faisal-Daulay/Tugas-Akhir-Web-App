                ...
                <table class="table datatable">
                    ...
                    <tbody>
                        <?php
                            ...
                            $dml = "SELECT * FROM kursus_siswa INNER JOIN siswa ON kursus_siswa.id_siswa = siswa.id_siswa INNER JOIN kursus ON kursus_siswa.id_kursus = kursus.id_kursus INNER JOIN kelas ON kursus_siswa.id_kelas = kelas.id_kelas";
                            $result = $db -> query($dml);
